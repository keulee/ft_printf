...
int main(void)
{
    ...
    //예외
    ft_printf_count = ft_printf("With the width and minus flag: |%0.0d|\n", 0);
    printf_count = printf("With the width and minus flag: |%0.0d|\n", 0);
    printf("ft printf count : %d\n", ft_printf_count);
    printf("real printf count : %d\n", printf_count);
    ...
    ft_printf_count = ft_printf("With the width and minus flag: |%0.5d|\n", 12345);
    printf_count = printf("With the width and minus flag: |%0.5d|\n", 12345);
    printf("ft printf count : %d\n", ft_printf_count);
    printf("real printf count : %d\n", printf_count);

    ft_printf_count = ft_printf("With the width and minus flag: |%1.0d|\n", 12345);
    printf_count = printf("With the width and minus flag: |%1.0d|\n", 12345);
    printf("ft printf count : %d\n", ft_printf_count);
    printf("real printf count : %d\n", printf_count);

    //
    ft_printf_count = ft_printf("With the width and minus flag: |%1.2d|\n", 12345);
    printf_count = printf("With the width and minus flag: |%1.2d|\n", 12345);
    printf("ft printf count : %d\n", ft_printf_count);
    printf("real printf count : %d\n", printf_count);

    ft_printf_count = ft_printf("With the width and minus flag: |%42.12d|\n", 12345);
    printf_count = printf("With the width and minus flag: |%42.12d|\n", 12345);
    printf("ft printf count : %d\n", ft_printf_count);
    printf("real printf count : %d\n", printf_count);
